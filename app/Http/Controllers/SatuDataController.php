...
class SatuDataController extends Controller
{
    public function index()
    {
        ...
        $route = route('satudata.index');
        return view('frontend.satudata.index', [
            'title' => $title,
            'name' => $name,
            'route' => $route,
    ...
    {
        $title = 'SDKP - Rumah Data';
        // Breadcrumbs
        $bread_1 = 'Rumah Data';
        $data = [
            [
                'nama' => 'Lahan',
                'link' => route('satudata.rd_lahan'),
            ],
            [
                'nama' => 'Akses Jalan',
                'link' => route('satudata.rd_jalan'),
            ],
            [
                'nama' => 'Bangunan',
                'link' => route('satudata.rd_bangunan'),
            ],
            [
                'nama' => 'Sarana Umum',
                'link' => route('satudata.rd_umum'),
            ],
            [
                'nama' => 'Wirausaha',
                'link' => route('satudata.rd_usaha'),
            ],
            [
                'nama' => 'Rumah Isi',
                'link' => route('satudata.rd_rmhisi'),
            ],
            [
                'nama' => 'Rumah Kosong',
                'link' => route('satudata.rd_rmhkosong'),
            ],
            [
                'nama' =>    'SPPT PBB',
                'link' => route('satudata.rd_spptpbb'),
            ],
            [
                'nama' =>   'Kependudukan',
                'link' => route('satudata.rd_penduduk'),
            ],
            [
                'nama' =>     'Umur',
                'link' => route('satudata.rd_umur'),
            ],
            [
                'nama' =>    'Meninggal',
                'link' => route('satudata.rd_meninggal'),
            ],
            [
                'nama' =>     'Kesehatan',
                'link' => route('satudata.rd_kesehatan'),
            ],
            [
                'nama' =>      'Pendidikan',
                'link' => route('satudata.rd_pendidikan'),
            ],
            [
                'nama' =>    'SAGASAJA',
                'link' => route('satudata.rd_beasiswa'),
            ],
            [
                'nama' =>   'Bantuan Sosial',
                'link' => route('satudata.rd_bantuansos'),
            ],
            [
                'nama' =>  'Dasawisma PKK',
                'link' => route('satudata.rd_pkk'),
            ],
            [
                'nama' =>  'Posyandu',
                'link' => route('satudata.rd_posyandu'),
            ],
            [
                'nama' =>    'Pertanian',
                'link' => route('satudata.rd_pertanian'),
            ],
            [
                'nama' =>    'Peternakan',
                'link' => route('satudata.rd_peternakan'),
            ],
            [
                'nama' =>    'Perikanan',
                'link' => route('satudata.rd_perikanan'),
            ],
        ];

        $route = route('satudata.index');
        $name = 'Satu Data Kota Pariaman';
        return view('frontend.satudata.rumahdata.rumah_data', [
            'title' => $title,
            'bread_1' => $bread_1,
            'data' => $data,
            'route' => $route,
    ...
    public function rd_lahan()
    {
        ...
        $breadcrumbs = [
            [
                'nama' => 'Rumah Data',
                'sub' => 'Data Lahan',
                'link' => route('satudata.rumah_data')
            ],
        ];
        $menu = 'Data Lahan';
        ...
        return view('frontend.satudata.rumahdata.page_rumahdata', [
            'title' => $title,
    ...
    public function rd_penduduk()
    {
        ...
        $data = [
            ...
            ['label' => 'Total Kartu Keluarga Dalam Kota', 'satuan' => 'KK'],
        ...
        return view('frontend.satudata.rumahdata.page_kependudukan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
            'data' => $data,
            'kkmasuk' => $kk_masuk,
    ...
    public function rd_umur()
    {
        ...
        return view('frontend.satudata.rumahdata.page_umur', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function rd_detail_umur()
    {
        ...
        return view('frontend.satudata.rumahdata.detailumur', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function rd_meninggal()
    {
        ...
        return view('frontend.satudata.rumahdata.page_meninggal', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function statistik()
    {
        ...
        $breadcrumbs = [
            [
                'nama' => 'Statistik',
                'sub' => '',
                'link' => route('satudata.statistik')
            ],
        ];
        $data = [
            [
                'nama' => 'Lahan',
                'link' => route('satudata.stk_lahan'),
            ],
            [
                'nama' => 'Akses Jalan',
                'link' => route('satudata.stk_jalan'),
            ],
            [
                'nama' => 'Bangunan',
                'link' => route('satudata.stk_bangunan'),
            ],

            [
                'nama' => 'Wirausaha',
                'link' => route('satudata.stk_usaha'),
            ],
            [
                'nama' =>   'Kependudukan',
                'link' => route('satudata.stk_penduduk'),
            ],
            [
                'nama' =>      'Pendidikan',
                'link' => route('satudata.stk_pendidikan'),
            ],
            [
                'nama' =>   'Bantuan Sosial',
                'link' => route('satudata.stk_bantuan'),
            ],
            [
                'nama' =>   'Pertanian',
                'link' => route('satudata.stk_pertanian'),
            ],
            [
                'nama' =>   'Peternakan',
                'link' => route('satudata.stk_peternakan'),
            ],
            [
                'nama' =>   'Perikanan',
                'link' => route('satudata.stk_perikanan'),
            ],
        ];
        $route = route('satudata.index');
        $name = 'Satu Data Kota Pariaman';
        return view('frontend.satudata.statistik.statistik', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
            'data' => $data,
            'route' => $route,
    ...
    public function stk_lahan()
    {
        ...
        return view('frontend.satudata.statistik.page_lahan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
            'data' => $data,
            'route' => $route,
    ...
    public function stk_jalan()
    {
        ...
        return view('frontend.satudata.statistik.page_jalan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_bangunan()
    {
        ...
        return view('frontend.satudata.statistik.page_bangunan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_usaha()
    {
        ...
        return view('frontend.satudata.statistik.page_usaha', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_penduduk()
    {
        ...
        $desa = DB::table('desas')
            ...
            ->paginate(100);
        $totalkk =  [
            'KK Dalam Desa / Kel (65%)',
            'KK Luar Desa / Kel Disatu Kec (15%)',
            'KK Luar Desa / Kel Beda Kec Disatu Kota (20%)',
        ];
        $rangkingkemiskinan =  [
            ' KK Mampu (60%)',
            ' KK Biasa (20%)',
        ...
        return view('frontend.satudata.statistik.page_kependudukan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_pendidikan()
    {
        ...
        return view('frontend.satudata.statistik.page_pendidikan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_bantuan()
    {
        ...
        return view('frontend.satudata.statistik.page_bantuansosial', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_pertanian()
    {
        ...
        return view('frontend.satudata.statistik.page_pertanian', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_peternakan()
    {
        ...
        return view('frontend.satudata.statistik.page_peternakan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
    ...
    public function stk_perikanan()
    {
        ...
        return view('frontend.satudata.statistik.page_perikanan', [
            'title' => $title,
            'breadcrumbs' => $breadcrumbs,
