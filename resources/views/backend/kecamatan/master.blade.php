...
<head>
    ...
    <title>SDKP | @yield('title') Kecamtan Pariaman @yield('kecamatan')</title>
...
<body>
    ...
    <div id="page-container"
            ...
            <div class="bg-image"
                ...
                <div class="bg-primary-op">
                    <div class="content-header">
                        ...
                        <!-- User Info -->
                        <div class="ms-2">
                            <a class="text-white fw-semibold" href="be_pages_generic_profile.html">Admin Kec.
                                {{ $kecamatan }}</a>
        ...
        @include('backend.kecamatan._sidebar')
        <!-- END Sidebar -->

        <!-- Header -->
        @include('backend.kecamatan._header')
        <!-- END Header -->

        <!-- Main Container -->
        <main id="main-container">
            <!-- Hero -->
            @include('backend.kecamatan._hero')
            <!-- END Hero -->
