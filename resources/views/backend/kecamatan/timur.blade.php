@extends('backend.kecamatan.master')
@section('title')
    Dashboard
@endsection
@section('kecamatan')
                        ...
                        <div class="p-md-2 p-lg-3">
                            <div class="py-3">
                                ...
                                <div class="py-3 d-flex align-items-center">
                                    ...
                                    <p class="mb-0">
                                        You have a <span class="fw-semibold text-success">12% customer
                                            growth</span> in the last 30 days. This is amazing, keep it up!
                                    </p>
                                </div>
                            </div>
                            <div class="py-3">
                        ...
                        <table class="table table-striped table-hover table-borderless table-vcenter fs-sm">
                            <thead>
                                <tr class="text-uppercase">
                                    ...
                                    <th>Status</th>
                                    <th class="d-none d-sm-table-cell text-end" style="width: 120px;">Price
                                    </th>
                                    <th></th>
                                </tr>
                            </thead>
