    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-xl-6">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Status Kartu Keluarga </h3>
                    ...
                    <div class="block-content block-content-full text-center">
                        <div class="py-3">
                            ...
                            <canvas id="js-chartjs-pie-statuskk"></canvas>
                        </div>
                    </div>
                </div>
                <!-- END Donut Chart -->
            ...
            <div class="col-xl-6">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Status Kependudukan</h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-toggle="block-option"
                                data-action="state_toggle" data-action-mode="demo">
                                <i class="si si-refresh"></i>
                    ...
                    <div class="block-content block-content-full text-center">
                        <div class="py-3">
                            <!-- Donut Chart Container -->
                            <canvas id="js-chartjs-pie-statuspenduduk"></canvas>
                        </div>
                    </div>
                </div>
                <!-- END Donut Chart -->
    ...
    <script>
        Dashmix.onLoad(class {
            static initChartsChartJS() {
                ...
                let data_statuskk,
                    data_statuspenduduk = document.getElementById(
                        "js-chartjs-lines"),
                    statuskk = document.getElementById("js-chartjs-pie-statuskk"),
                    statuspenduduk = document.getElementById("js-chartjs-pie-statuspenduduk");
                data_statuskk = {
                        labels: [
                            'Total KK Keluar November - 2022 (30%)',
                            'Total KK Masuk November - 2022 (10%)',
                            'Total KK Pecahan November - 2022 (60%)',
                        ],
                        datasets: [{
                            data: [
                                30,
                    ...
                    null !== statuskk && (statuskk = new Chart(statuskk, {
                        type: "pie",
                        data: data_statuskk
                    })),
                    null !== statuspenduduk && (statuspenduduk = new Chart(statuspenduduk, {
                        type: "pie",
                        data: data_statuspenduduk
                    }));
