                                ...
                                <td>
                                    <a class="nav-main-link" href="#">
                                        <div class="block-content block-content-full text-center">
                                            <div class="py-3">
                                                <!-- Pie Chart Container -->
                                                <canvas id="js-chartjs-pie-jenisjalan"></canvas>
                                            </div>
                                        </div>
                                    </a>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a class="nav-main-link" href="#">
                                        <div class="block-content block-content-full text-center">
                                            <div class="py-3">
                                                <!-- Pie Chart Container -->
                                                <canvas id="js-chartjs-pie-statusjalan"></canvas>
                                            </div>
                                        </div>
                                    </a>
                                </td>
    ...
    <script>
        Dashmix.onLoad(class {
            static initChartsChartJS() {
                ...
                let d_statistik, d_jenis, d_status = document.getElementById(
                        "js-chartjs-lines"),
                    jenisjalan = document.getElementById("js-chartjs-pie-jenisjalan"),
                    statusjalan = document.getElementById("js-chartjs-pie-statusjalan"),
                ...
                d_statistik = {
                    ...
                    null !== jenisjalan && (jenisjalan = new Chart(jenisjalan, {
                        type: "pie",
                        data: d_jenis
                    })),
                    null !== statusjalan && (statusjalan = new Chart(statusjalan, {
                        type: "pie",
                        data: d_status
                    })),
